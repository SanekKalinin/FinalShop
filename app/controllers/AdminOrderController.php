...
class AdminOrderController extends AdminBase
{
    ...
    public function actionIndex()
    {
        ...
        // Подключаем вид
        require_once(BASEPATH . '/app/views/admin_order/index.php');
        return true;
    }
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            // Сохраняем изменения
            $this->order->updateOrderById($id, $userName, $userPhone, $userComment, $date, $status);
        ...
        // Подключаем вид
        require_once(BASEPATH . '/app/views/admin_order/update.php');
        return true;
    }
    ...
    public function actionView($id)
    {
        ...
        // Подключаем вид
        require_once(BASEPATH . '/app/views/admin_order/view.php');
        return true;
    }
    ...
    public function actionDelete($id)
    {
        ...
        // Подключаем вид
        require_once(BASEPATH . '/app/views/admin_order/delete.php');
        return true;
    }
