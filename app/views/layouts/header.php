                            ...
                            <div class="col-sm-6">
                                <div class="contactinfo">
                                    <ul class="nav nav-pills">
                                        <li><a href="#"><i class="fa fa-phone"></i> ТУТ НОМЕР ТЕЛЕФОНА</a></li>
                                        <li><a href="#"><i class="fa fa-envelope"></i> ТУТ ПОЧТА</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="logo pull-left">
                                    <a href="/"><img src="/app/template/images/home/logo.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-sm-8">
